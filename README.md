...
- Inspired by the [roadmap.sh](https://roadmap.sh/projects/number-guessing-game) backend project: [https://roadmap.sh/projects/number-guessing-game](https://roadmap.sh/projects/number-guessing-game)
